...
export const Footer = ({ className, ...props }: ComponentProps<"footer">) => {
  ...
  return (
    <footer
      className={clsx(
        "w-8/12 mx-auto flex flex-col font-medium text-zinc-700 dark:text-zinc-100 md:pt-0 pt-5 ",
        className
      )}
      {...props}
    >
      ...
      <div className="flex items-center pt-2">
        <span>
          <Emoji />{" "}
          <time className="hidden sm:inline text-white font-bold" dateTime={String(year)}>
            {year}{" "}
          </time>
           <h1 className="font-bold flex justify-center">— he / him </h1>

        </span>
        <a
          className="link ml-auto inline-flex items-center gap-1.5"
          href="https://github.com/sudobaby"
          rel="noreferrer"
          target="_blank"
        >
          <svg
          ...
          <span>
            <span> <h1 className="text-2x1 font-bold text-white underline">sudobaby</h1></span>
